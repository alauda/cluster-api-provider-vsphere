...
// ResourceSlotNetwork defines the primary and additional network configurations for a slot.
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ResourceSlotNetwork) DeepCopyInto(out *ResourceSlotNetwork) {
	*out = *in
